...
#define GDT_CODE_ATTR_LOW_DPL3                                                 \
    ((DESC_P << 7) + (RPL3 << 5) + (DESC_S_CODE << 4) + DESC_TYPE_CODE)
#define GDT_DATA_ATTR_LOW_DPL3                                                 \
    ((DESC_P << 7) + (RPL3 << 5) + (DESC_S_DATA << 4) + DESC_TYPE_DATA)
...
#define TSS_ATTR_HIGH                                                          \
    ((DESC_G_4K << 7) + (TSS_DESC_D << 6) + (DESC_L << 5) + (DESC_AVL << 4) +  \
     0x0)
#define TSS_ATTR_LOW                                                           \
    ((DESC_P << 7) + (RPL0 << 5) + (DESC_S_SYS << 4) + DESC_TYPE_TSS)
...
#define IDT_DESC_16_TYPE 0x6 // 16位的中断门
